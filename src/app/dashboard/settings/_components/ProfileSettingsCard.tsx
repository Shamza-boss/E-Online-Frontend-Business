...
const cardBg = (theme: Theme) =>
    `linear-gradient(135deg, ${alpha(theme.palette.background.paper, 0.9)} 0%, ${theme.palette.background.paper
    } 60%)`;
            ...
            <CardContent>
                <Stack spacing={4}>
                    ...
                    <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                        ...
                        <DetailBlock
                            label="Role"
                            value={user.role ? formatRoleLabel(user.role) : 'Not assigned'}
                        />
                        <DetailBlock
                            label="Institution"
