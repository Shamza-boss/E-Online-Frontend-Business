...
const canSend = (s: InvoiceStatus) => s === 'Draft' || s === 'Sent';
const canPay = (s: InvoiceStatus) => s === 'Sent' || s === 'Overdue';
const canCancel = (s: InvoiceStatus) => s !== 'Paid' && s !== 'Cancelled';
const canUnpay = (s: InvoiceStatus) => s === 'Paid';
